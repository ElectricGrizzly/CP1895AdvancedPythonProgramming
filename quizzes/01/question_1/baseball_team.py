...
def add_player(players: list[dict]) -> None:
    """Add a player dictionary to player list."""
    name: str = input("Name: ")
...
def move_player(players: list[dict]) -> None:
    ...
    player: dict = players[old_number-1]
...
def display_lineup(players: list[dict]) -> None:
    ...
    if players == None:
        ...
        for player in players:
            avg: float = get_batting_avg(player['at_bats'], player['hits'])
